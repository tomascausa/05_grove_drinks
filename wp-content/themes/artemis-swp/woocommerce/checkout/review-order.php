...
<table class="shop_table woocommerce-checkout-review-order-table">
				...
				if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_checkout_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
					...
					<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
						<td class="product-name">
                            ...
                            ?>
                            <div class="woocomerce-cart-item-product-image">
						        <?php echo str_replace( array( 'http:', 'https:' ), '', $thumbnail ); ?>
                            </div>
                            <div class="woocommerce_cart_item_details">
						...
						<td class="product-total">
                            ...
                            <?php
                                echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf(
                                    '<a href="%s" class="remove-item" title="%s" data-product_id="%s" data-product_sku="%s">%s</a>',
	...
	<tfoot>
		...
		<tr class="cart-subtotal">
			<th><?php esc_html_e( 'Subtotal', 'artemis-swp' ); ?></th>
		...
		<tr class="order-total">
			<th><?php esc_html_e( 'Grand Total', 'artemis-swp' ); ?></th>
