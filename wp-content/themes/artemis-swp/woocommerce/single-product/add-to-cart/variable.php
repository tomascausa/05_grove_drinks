				...
				<?php foreach ( $attributes as $attribute_name => $options ) : ?>
                    <tr>
						<td class="label"><label
                                    for="<?php echo sanitize_title( $attribute_name ); ?>"><?php echo wc_attribute_label( $attribute_name ); ?></label></td>
						<td class="value">
							<?php
								...
								wc_dropdown_variation_attribute_options(
									array(
										...
										'product'   => $product,
										'selected'  => $selected,
                                        'show_option_none' => sprintf(esc_html__( 'Choose %s', 'artemis-swp' ), ucwords( wc_attribute_label($attribute_name, $product)))
									)
								);
								/*
