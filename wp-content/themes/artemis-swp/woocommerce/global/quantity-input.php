<?php
    ...
    if ( $max_value && $min_value === $max_value ) {
        ...
        <div class="quantity hidden at_swp_hidden">
            <input type="hidden" class="qty" id="<?php echo esc_attr( $input_id ); ?>" name="<?php echo esc_attr( $input_name ); ?>" value="<?php echo esc_attr( $min_value ); ?>"/>
        </div>
    <?php } else { ?>
        <div class="quantity noselect <?php echo esc_attr( $class ) ?>">
