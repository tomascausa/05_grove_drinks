<?php
	...
	$pre_header_class = 'pre_header clearfix classic_double_menu_logo_center';
...
<header id="at_page_header" class="classic_double_menu_logo_center <?php echo esc_attr($header_class); ?>" data-menubg="<?php echo esc_attr($menu_bar_bg); ?>" data-menucol="<?php echo esc_attr($menu_txt_col); ?>">
