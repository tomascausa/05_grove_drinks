<?php
	...
	$pre_header_class = 'pre_header clearfix classic_double_menu_logo_center menu_center_only';
...
<header id="at_page_header" class="classic_double_menu_logo_center menu_center_only <?php echo esc_attr($header_class); ?>" data-menubg="<?php echo esc_attr($menu_bar_bg); ?>" data-menucol="<?php echo esc_attr($menu_txt_col); ?>">
	...
	<div class="header_inner lc_wide_menu <?php echo esc_attr($header_width); ?>">
		...
		wp_nav_menu(
			array(
				...
				'container'			=> 'nav',
				'container_class'	=> 'classic_menu classic_double_menu',
				'walker'			=> $customWalker
			)
		);
		?>
