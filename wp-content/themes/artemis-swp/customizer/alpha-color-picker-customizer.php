...
class Customize_Alpha_Color_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script(
			...
			get_template_directory_uri() . '/customizer/js/alpha-color-picker-customizer.js',
		...
		wp_enqueue_style(
			'alpha-color-picker-customizer',
			get_template_directory_uri() . '/customizer/css/alpha-color-picker-customizer.css',
	...
	public function render_content() {
		...
		/*
			smartwpress - 
			moved out of label because of 
			WordPress update 4.9.1 - label was part of the hidden element
		*/
